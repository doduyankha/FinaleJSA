...
// git add . : đẩy tất cả các file thay đổi vào trong vùng stage
// git commit -m"Nội dung muốn thông báo"
// git push : đẩy tất cả các file lên git
// var listIMG = [
//     img = "https://orangecountyzest.com/wp-content/uploads/2016/01/2016_Valentine_Heart_Boxes_Banner.png",
      
//     img = "https://img.freepik.com/premium-vector/happy-valentines-day-banner-illustration_563530-114.jpg",

//     img = "https://s3.amazonaws.com/thumbnails.venngage.com/template/a49fa70a-db55-40a0-aa9a-45488ef80cb5.png",
      
//     img = "https://media.istockphoto.com/id/1295969769/vector/valentines-day-banner.jpg?s=612x612&w=0&k=20&c=FBp0R9M_KT8GFhF5UE3YhOH48VQePnPtDHtQ0qJx4PI=",

//     img = "https://img.freepik.com/premium-vector/happy-valentine-s-day-banner-with-cute-heart-desserts-chocolate-bar-gift-box_116796-327.jpg?w=2000",
// ]
// var _img = document.querySelector(".banner");
// var d=0;


// let slideshow=() => {
//         if(d==listIMG.length) d=0;
//         _img.src = listIMG[d];
//         d++;
//     }

// setInterval( slideshow , 2252);
const arrListProduct = [
    {
        img: "https://th.bing.com/th/id/R.f6267d6249671bb1a38426245d844c43?rik=TZPhpBNF3np1bQ&pid=ImgRaw&r=0",
        name: "Ferero Rocher",
